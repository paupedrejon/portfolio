  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-[#0a0a0f] flex flex-col items-center justify-center px-4 md:px-6 pt-20">
        <h1 className="text-center text-white text-4xl sm:text-5xl md:text-6xl font-bold">Hello World</h1>
      ...
      <section id="about" className="px-4 md:px-8 py-16 max-w-2xl mx-auto">
