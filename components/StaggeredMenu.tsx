...
export const StaggeredMenu = ({
  ...
  const hamburgerTweenRef = useRef<gsap.core.Timeline | null>(null);
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      if (!panel || !line1 || !line2 || !line3) return;
  ...
  const animateIcon = useCallback((opening: boolean) => {
    ...
    if (opening) {
      hamburgerTweenRef.current = gsap.timeline()
        .to(line1, { y: 10, rotate: 45, duration: 0.3, ease: "power3.out" }, 0)
        .to(line2, { opacity: 0, duration: 0.2, ease: "power2.out" }, 0)
        .to(line3, { y: -10, rotate: -45, duration: 0.3, ease: "power3.out" }, 0);
    } else {
      hamburgerTweenRef.current = gsap.timeline()
        .to(line1, { y: 0, rotate: 0, duration: 0.3, ease: "power3.inOut" }, 0)
        .to(line2, { opacity: 1, duration: 0.2, ease: "power2.out" }, 0)
        .to(line3, { y: 0, rotate: 0, duration: 0.3, ease: "power3.inOut" }, 0);
    }
  }, []);
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "1.5rem" }}>
          ...
          <button
          ref={toggleBtnRef}
          className="sm-toggle sm-toggle-hamburger"
