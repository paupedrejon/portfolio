...
- El ejercicio debe ser práctico y ejecutable, no teórico`;
  ...
  const handleTestSubmit = async () => {
    ...
    try {
      ...
      // F1.4: el dominio cambió → invitar a recalcular el plan (secuenciación adaptativa)
      if (isStudyAgentsFlagEnabled("studyPlan")) {
        addMessage({
          role: "assistant",
          content:
            "Tu mapa de dominio se actualizó con este test. Abre **Plan** para regenerarlo: priorizará los gaps nuevos y reinyectará lo que hayas fallado.",
          type: "message",
        });
      }
