...
class CorrectionAgent:
    ...
    def review_and_correct(
        ...
        # Preparar texto de apuntes anteriores SIN f-strings anidados
        # (evita: SyntaxError: f-string expression part cannot include a backslash)
        previous_notes_text = ""
        if is_notes:
...
- Si "respuesta_corregida" contiene comillas, saltos de línea o caracteres especiales, escápalos correctamente (\\n para saltos de línea, \\" para comillas)"""
