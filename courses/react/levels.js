    ...
    checkpoints: [
      {
        ...
        hintSteps: [
          ...
          { type: "tip", text: "No borres el hero del nivel 1" },
          { type: "code", text: "Mantén:", code: '<h1 className="text-center text-white text-4xl font-bold">Hello World</h1>' },
        ],
      },
      {
        ...
        hintSteps: [
          { type: "action", text: "El <main> debe tener flex flex-col items-center justify-center" },
          {
            type: "code",
            text: "Ejemplo:",
            code: 'className="min-h-screen bg-[#0a0a0f] flex flex-col items-center justify-center"',
      ...
      {
        id: "subtitle-p-exists",
        label: "Has añadido un <p> en el hero",
        assert: "main contains a p element",
        hintSteps: [
          { type: "action", text: "Debajo del </h1>, nueva línea con un <p></p>" },
          { type: "tip", text: "Aún puede estar vacío en este paso" },
        ],
      },
      {
        id: "subtitle-text-length",
        label: "El párrafo tiene tu presentación (10+ caracteres)",
        assert: "p has at least 10 characters",
        hintSteps: [
          { type: "code", text: "Texto ejemplo:", code: "<p>Desarrollador web en formación</p>" },
        ],
      },
      {
        id: "subtitle-below-h1",
        label: "El párrafo está debajo del h1 (no al lado)",
        assert: "p is below h1 vertically",
        hintSteps: [
          { type: "tip", text: "Orden en el código: primero h1, luego p" },
          { type: "action", text: "Si se ven en horizontal, revisa flex-col en el main" },
        ],
      },
      {
        id: "subtitle-styled",
        label: "El párrafo tiene estilo (gris, margen o centrado)",
        assert: "subtitle has muted/centered styles",
        hintSteps: [
          { type: "code", text: "Clases sugeridas:", code: 'className="text-gray-300 mt-4 text-center max-w-md"' },
        ],
      },
      {
        id: "cta-plain-exists",
        label: "Existe un botón «Ver proyectos» (sin estilo aún)",
        assert: "plain CTA button exists",
        hintSteps: [
          { type: "code", text: "Mínimo:", code: '<button type="button">Ver proyectos</button>' },
        ],
      },
      {
        id: "cta-below-subtitle",
        label: "El botón está debajo del párrafo",
        assert: "button is below paragraph",
        hintSteps: [
          { type: "action", text: "Orden: h1 → p → button" },
        ],
      },
      {
        id: "hero-vertical-stack-final",
        label: "h1, párrafo y botón en columna sin solaparse",
        assert: "vertical stack without overlap",
        hintSteps: [
          { type: "tip", text: "Comprueba en el navegador que nada se tapa" },
        ],
      },
      {
        id: "cta-padding",
        label: "El botón tiene padding (px-6 py-3)",
        assert: "CTA padding >= 8px vertical",
        hintSteps: [
          { type: "action", text: "Solo añade padding al botón" },
          { type: "code", text: "Clase:", code: 'className="px-6 py-3"' },
        ],
      },
      {
        id: "cta-rounded",
        label: "El botón tiene bordes redondeados",
        assert: "CTA border-radius >= 4px",
        hintSteps: [
          { type: "action", text: "Añade rounded-full al botón" },
        ],
      },
      {
        id: "cta-teal-style",
        label: "El botón es teal con texto blanco",
        assert: "CTA brand colors",
        hintSteps: [
          {
            type: "code",
            text: "Estilo final del botón:",
